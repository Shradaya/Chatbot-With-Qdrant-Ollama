QUESTIONS = [
  ...
  "answer": """The  sovereignty  and  state  authority  of  Nepal  shall be vested to the Nepalese people""" },
  ...
  "answer": """Nepali language in the Devanagari script is the official language of Nepal""" },
  { "question": "What are the different languages spoken?",
  "answer": """All languages spoken as the mother tongues in Nepal are the languages of the nation.""" },
  ...
  "answer": """Secular Nation, Multi Religious""" },
  { "question": "Are there any specific rights provided to women?",
  "answer": """Yes, There is specific right provided to women""" },
  ...
  "answer": """Giving opinions and advices on constitutional and legal matters. Representing the Government of Nepal in lawsuits wherein the rights. Defending any lawsuit in which the Government of Nepal is a plaintiff or a defendant on behalf of the Government of Nepal""" },
  ...
  "answer": """Mayor and Deputy Mayor of the Municipal Executive; Ward Chairpersons; and four members elected from each Ward; and members of the Municipal Executive elected from Dalit or minority communities pursuant""" },
  { "question": "Who has the power to make law?",
  "answer": """The Federal Parliament, Federation; State and Local level, holds the power to make law""" }
]
